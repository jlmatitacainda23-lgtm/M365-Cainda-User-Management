# Relatório de Laboratório: Administração de Identidades no 1º Laboratório da Semanano na Microsoft 365
**Realizado por:** José Lucas Cainda

## 1. Objetivo do Laboratório
Demonstrar a proficiência técnica na gestão de identidades e licenciamento no ecossistema Microsoft 365, focando-se na integração técnica de novos utilizadores.

## 2. Passos Executados
* **Criação de Perfil:** Configurei o utilizador `Cainda Teste23` com o e-mail institucional correspondente.
* **Segurança de Acesso:** Defini a geração automática de palavra-passe com a política de alteração obrigatória no primeiro acesso.
